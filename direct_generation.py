...
#
    ...
    generate(test_smile_file=args.input, beam_size=args.beam_size, encoder=encoder, decoder=decoder)
...
def generate(test_smile_file, beam_size, encoder, decoder):
    ...
    with open(test_smile_file, "r") as fp:
        ...
        for smile in fp:
            ...
            if mol1 is None:
                continue
            voxel_input, _ = get_mol_voxels(smile)
            if voxel_input == None:
                smile_idx += 1
                continue
            outputs = caption_voxel_beam_search(encoder, decoder, smile,
            ...
            for idx,gen_smile in enumerate(outputs):
                ...
                if mol is not None:
                        ...
                        #generated_smiles.write(gen_smile+',')
                    #else:
                        #generated_smiles.write(gen_smile + '\n')
                    ...
                    gen_compounds.append(gen_smile)
            ...
            if output_smile:
                ...
                for gen_smile in gen_compounds:
                    generated_smiles.write(str(smile_idx)+gen_smile+'\n')
